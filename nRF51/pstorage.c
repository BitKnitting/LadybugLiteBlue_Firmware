...
uint32_t pstorage_store(pstorage_handle_t * p_dest,
                        ...
                        pstorage_size_t     offset)
{
  SEGGER_RTT_WriteString(0,"==> IN pstorage_store\n");
    VERIFY_MODULE_INITIALIZED();
    ...
    is_word_aligned(p_src)? SEGGER_RTT_WriteString(0,"pSrc IS word aligned\n") : SEGGER_RTT_WriteString(0,"pSrcs IS NOT word aligned\n");
    is_word_aligned((void *)(uint32_t)offset)? SEGGER_RTT_WriteString(0,"offset IS word aligned\n") : SEGGER_RTT_WriteString(0,"offset IS NOT word aligned\n");
    is_word_aligned((uint32_t *)p_dest->block_id)? SEGGER_RTT_WriteString(0,"blockID IS word aligned\n") : SEGGER_RTT_WriteString(0,"blockID IS NOT word aligned\n");
